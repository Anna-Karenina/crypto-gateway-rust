# 🏦 Multi-Token TRC-20 Payment Gateway

**Production-ready E-commerce Multi-Token Payment Processing System**

Микросервис для обработки TRC-20 платежей в интернет-магазинах с поддержкой множественных токенов (USDT, USDC, BTT и других) на сети TRON.
...
- [🪙 Мультитокенная архитектура](#-мультитокенная-архитектура)
- [🏗️ Архитектура](#️-архитектура)
- [🔧 Настройка](#-настройка)
- [🚀 Запуск](#-запуск)
- [📡 API Endpoints](#-api-endpoints)
- [🌟 Новые Multi-Token API](#-новые-multi-token-api)
